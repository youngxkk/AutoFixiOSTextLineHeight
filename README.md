...
1. [下载 zip 安装包](https://codeload.github.com/youngxkk/AutoFixiOSTextLine/master/AutoFixiOSTextLineHeight.zip) 解压缩。 *(支持 Sketch v50 以上版本)  
2. 双击`.sketchplugin` 安装使用。
#### 
1. [Download the Zip file](https://codeload.github.com/youngxkk/AutoFixiOSTextLine/master/AutoFixiOSTextLineHeight.zip) and unzip。 *(Support Sketch Version 50) 
